...
import { SiNextdotjs, SiVuedotjs, SiTypescript, SiTailwindcss, SiShopify, SiSanity } from "react-icons/si";
...
export default function TechStack() {
  const techIcons = [
    ...
    { icon: <SiSanity className="text-red-500 text-4xl hover:drop-shadow-[0_0_10px_rgba(255,191,0,0.7)] transition" />, name: "Sanity" },
